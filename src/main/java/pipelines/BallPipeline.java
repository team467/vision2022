...
public class BallPipeline extends Pipeline{
	...
	public void process(Mat source0) {
		...
		double[] hslThreshold0Saturation = {0.0, 255.0}; //{117.86870503597122, 255.0};
		double[] hslThreshold0Luminance = {32.10431654676259, 255.0};
		...
		double[] rgbThreshold0Green = {89.43345323741006, 255.0};
		double[] rgbThreshold0Blue = {82.55395683453237, 255.0};
		...
		double[] hslThreshold1Saturation = {0.0, 255.0}; //{227.5988700564972, 255.0};
		double[] hslThreshold1Luminance = {0.0, 163.12829525483306}; //{115.25423728813561, 163.12829525483306};
		...
		double[] rgbThreshold1Red = {235.31073446327682, 255.0};
		double[] rgbThreshold1Green = {0.0, 255.0};
		double[] rgbThreshold1Blue = {0.0, 205.70298769771532};
