...
public class StreamProfile implements NativeDecorator<rs2_stream_profile> {
    ...
    private static final ThreadLocal<IntPointer> nativeStreamIndexPtr = ThreadLocal
            .withInitial(() -> new IntPointer(1));
    private static final ThreadLocal<IntPointer> nativeFormatIndexPtr = ThreadLocal
            .withInitial(() -> new IntPointer(1));
