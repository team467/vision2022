...
public class Config implements NativeDecorator<rs2_config> {
    ...
    public void enableStream(Stream stream, int index) {
        rs2_config_enable_stream(instance, stream.getIndex(), index, 0, 0, Format.Any.getIndex(), 0,
    ...
    public void enableStream(Stream streamType, int streamIndex, int width, int height, Format format, int framerate) {
        rs2_config_enable_stream(instance, streamType.getIndex(), streamIndex, width, height, format.getIndex(),
                framerate, RealSenseError.getInstance());
        RealSenseError.checkError();
    }
    ...
    public void enableStream(Stream streamType, int width, int height, Format format, int framerate) {
        rs2_config_enable_stream(instance, streamType.getIndex(), -1, width, height, format.getIndex(), framerate,
                RealSenseError.getInstance());
        RealSenseError.checkError();
    }
    ...
    public void enableStream(Stream streamType, Format format, int framerate) {
        rs2_config_enable_stream(instance, streamType.getIndex(), -1, 0, 0, format.getIndex(), framerate,
                RealSenseError.getInstance());
        RealSenseError.checkError();
    }
    ...
    public void enableStream(Stream streamType, int streamIndex, Format format, int framerate) {
        rs2_config_enable_stream(instance, streamType.getIndex(), streamIndex, 0, 0, format.getIndex(), framerate,
                RealSenseError.getInstance());
        RealSenseError.checkError();
    }
